...
const (
	Crud_Create_FullMethodName  = "/golang_protobuf_user.Crud/Create"
	Crud_GetList_FullMethodName = "/golang_protobuf_user.Crud/GetList"
	Crud_GetOne_FullMethodName  = "/golang_protobuf_user.Crud/GetOne"
	Crud_Update_FullMethodName  = "/golang_protobuf_user.Crud/Update"
	Crud_Delete_FullMethodName  = "/golang_protobuf_user.Crud/Delete"
)
...
type CrudClient interface {
	Create(ctx context.Context, in *UserRepo_ProtoUser, opts ...grpc.CallOption) (*UserRepo_ProtoUser, error)
	GetList(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (Crud_GetListClient, error)
	GetOne(ctx context.Context, in *wrapperspb.Int64Value, opts ...grpc.CallOption) (*UserRepo_ProtoUser, error)
	Update(ctx context.Context, in *UpdateRequest, opts ...grpc.CallOption) (*UserRepo_ProtoUser, error)
...
func (c *crudClient) Create(ctx context.Context, in *UserRepo_ProtoUser, opts ...grpc.CallOption) (*UserRepo_ProtoUser, error) {
	out := new(UserRepo_ProtoUser)
...
func (x *crudGetListClient) Recv() (*UserRepo_ProtoUser, error) {
	m := new(UserRepo_ProtoUser)
...
func (c *crudClient) GetOne(ctx context.Context, in *wrapperspb.Int64Value, opts ...grpc.CallOption) (*UserRepo_ProtoUser, error) {
	out := new(UserRepo_ProtoUser)
...
func (c *crudClient) Update(ctx context.Context, in *UpdateRequest, opts ...grpc.CallOption) (*UserRepo_ProtoUser, error) {
	out := new(UserRepo_ProtoUser)
...
type CrudServer interface {
	Create(context.Context, *UserRepo_ProtoUser) (*UserRepo_ProtoUser, error)
	GetList(*emptypb.Empty, Crud_GetListServer) error
	GetOne(context.Context, *wrapperspb.Int64Value) (*UserRepo_ProtoUser, error)
	Update(context.Context, *UpdateRequest) (*UserRepo_ProtoUser, error)
...
func (UnimplementedCrudServer) Create(context.Context, *UserRepo_ProtoUser) (*UserRepo_ProtoUser, error) {
...
func (UnimplementedCrudServer) GetOne(context.Context, *wrapperspb.Int64Value) (*UserRepo_ProtoUser, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetOne not implemented")
}
func (UnimplementedCrudServer) Update(context.Context, *UpdateRequest) (*UserRepo_ProtoUser, error) {
...
func _Crud_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CrudServer).Create(ctx, req.(*UserRepo_ProtoUser))
	}
...
func (x *crudGetListServer) Send(m *UserRepo_ProtoUser) error {
...
var Crud_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "golang_protobuf_user.Crud",
